...
// written to disk.
  ...
  function claudePlaywrightServer(options) {
    ...
    return {
      type: "stdio",
      command: codexPlaywrightMcpCommand(options, installDir),
      args: ["--prefix", codexNpmPrefix(installDir), codexPlaywrightMcpBinaryName(options), "--cdp-endpoint", resolvePlaywrightMcpCdpEndpoint(options), "--shared-browser-context"],
